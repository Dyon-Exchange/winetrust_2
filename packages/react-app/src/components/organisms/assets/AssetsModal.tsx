...
const AssetsModal = ({ asset }: { asset: Asset }) => {
            ...
            <ModalBody>
              <VStack w="100%" align="start">
                ...
                <StyledBox>
                  ...
                  <StyledSeparator> : </StyledSeparator>
                  <StyledText>{externalURL}</StyledText>
                </StyledBox>
                <StyledBox>
                  <StyledLabel>Date Landed </StyledLabel>
                  <StyledSeparator> : </StyledSeparator>
                  <StyledText>{landedAt}</StyledText>
                </StyledBox>
                <StyledBox>
                  <StyledLabel>Date Tokenised </StyledLabel>
                  <StyledSeparator> : </StyledSeparator>
                  <StyledText>{tokenisedAt}</StyledText>
                </StyledBox>
                {labelImage && (
                  <Box>
                    Label Image :
